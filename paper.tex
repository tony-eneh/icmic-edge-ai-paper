...
Sensor tasks $\rightarrow$ preprocessing $\rightarrow$ model and uncertainty estimator $\rightarrow$ routing policy $\rightarrow$ local completion / peer forwarding / safe fallback\vspace{1em}
}}
