...
Recent maritime MEC studies provide useful context for routing and offloading design. Bandit-based server selection and deep reinforcement learning have been used for latency-energy trade-offs and hybrid offloading~\cite{yang2022mab_maritime,ning2025marho,he2025distributed_maritime}. Cooperative and UAV-assisted settings also report gains under dynamic maritime constraints~\cite{you2025joint_maritime,kong2025satd3_maritime,yang2025uavusv_edge}. Deployment-oriented and fault-tolerant formulations further motivate resilient policies that can maintain service under failures and link degradation~\cite{zhang2025deployment_maritime,yue2023offloading_maritime,zhang2024fault_tolerant_edge}.
